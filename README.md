...
Create your .env file as described in the Local Setup section. The docker-compose.yml is configured to load variables from it.
...
Ensure you have a .env file with SUPABASE_SECRET_KEY set (it can be any string for testing, as the mock JWT uses this).
